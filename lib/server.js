...
const { SERVICES_METHOD, AUTHORIZE_METHOD, ADD_SERVICE_EVENT, SERVICE_EVENT, errors } = require('./constants')
...
class Server extends EventEmitter {
	...
	_errorHandler(err) {
		if (err.code === errors.CONNECTION_RESET) {
			this.emit('connection_reset')
		} else {
			this.emit('error', err)
		}
	}
